  ...
  {tasks.map((task) => (
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 max-w-[150px] truncate">
          {task.title}
        </h2>
      ...
      <p className="text-gray-600 mt-2 text-sm max-h-[70px] overflow-auto pr-1">
        {task.description}
      </p>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => onEdit(task)}
            className="p-2 cursor-pointer bg-blue-100 rounded-md hover:bg-blue-200 transition"
          >
          ...
          <button
            ...
            className="p-2 cursor-pointer bg-red-100 rounded-md hover:bg-red-200 transition"
          >
